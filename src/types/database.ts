...
export interface Member {id:string;display_name:string;canonical_name:string;avatar_url:string|null;description:string|null;current_status:string|null;mbti?:string|null;birth_year?:number|null;birth_month?:number|null;sun_sign?:string|null;moon_sign?:string|null;rising_sign?:string|null;mercury_sign?:string|null;venus_sign?:string|null;mars_sign?:string|null;created_at?:string;updated_at?:string}
